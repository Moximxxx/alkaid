...
// 文本模型供应商列表（与 AI_PROVIDERS 对应，去掉 type 字段以兼容 Welcome/Settings 用法）
...
// 文本模型列表（与 AI_MODELS 对应，只包含文本 provider 的模型）
export const TEXT_MODELS: Record<string, { value: string; label: string }[]> = {
  doubao: [
    { value: "doubao-seed-2.0-pro", label: "Doubao-Seed-2.0-Pro（国内综合第一）" },
    { value: "doubao-2.0-pro", label: "Doubao-2.0-Pro" },
    { value: "doubao-2.0-lite", label: "Doubao-2.0-Lite" },
